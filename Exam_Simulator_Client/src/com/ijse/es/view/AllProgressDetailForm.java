 ...
 * @author ASUS
 */
public class AllProgressDetailForm extends javax.swing.JFrame implements Observer {
    ...
    public AllProgressDetailForm(LecturerDTO lecturerDTO) {
        try {
            initComponents();
            enhancements();
            setClock();
            ...
            Logger.getLogger(AllProgressDetailForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/es/images/progress1.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/es/images/student1.png"))); // NOI18N
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 0, 270, 140));
        ...
        tblStudent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "student name", "exam name", "subject", "date", "marks"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 740, 230));
        ...
        lblExam.setText("Exam Name");
        getContentPane().add(lblExam, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 144, 130, 50));

        lblBatch.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        lblBatch.setText("batch");
        getContentPane().add(lblBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 150, 90, 40));
        getContentPane().add(txtBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 150, 100, 40));

        lblSubject.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        lblSubject.setText("subject");
        getContentPane().add(lblSubject, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 150, 80, 40));

        jComboBox1.setFont(new java.awt.Font("Segoe UI Semibold", 0, 24)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "all", "batch", "exam", "subject" }));
        jComboBox1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBox1ItemStateChanged(evt);
            }
        });
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 150, 170, 40));

        txtExam.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        txtExam.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                txtExamItemStateChanged(evt);
            }
        });
        getContentPane().add(txtExam, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 120, 40));

        txtSubject.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        txtSubject.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "OOP", "DBMS" }));
        txtSubject.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                txtSubjectItemStateChanged(evt);
            }
        });
        getContentPane().add(txtSubject, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 150, 120, 40));
    ...
    private void txtExamItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_txtExamItemStateChanged
        String examName = (String) txtExam.getSelectedItem();
        getExamNameProgress(examName);
    }//GEN-LAST:event_txtExamItemStateChanged

    private void txtSubjectItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_txtSubjectItemStateChanged
        getDetailsForSubject();
    }//GEN-LAST:event_txtSubjectItemStateChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllProgressDetailForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox txtExam;
    ...
    private void loadExamCombo() {
        try {
            ExamController examController = ServerConnector.getServerConnector().getExamController();
            List<ExamDTO> examList = examController.getAllExam();
            for (ExamDTO examList1 : examList) {
                txtExam.addItem(examList1.getExamTitle());
            }
    ...
    private void getExamNameProgress(String examName) {
        try {
            dtm = (DefaultTableModel) tblStudent.getModel();
            dtm.setRowCount(0);
            ProgressDetailController examController = ServerConnector.getServerConnector().getProgressDetailController();
            List<ProgressDetailDTO> examList = examController.getAllProgressDetail();
            for (ProgressDetailDTO detailDTO : examList) {
                if (detailDTO.getExamDTO().getExamTitle().equals(examName)) {
                    Object rowData[] = {detailDTO.getStudentDTO().getName(), detailDTO.getExamDTO().getExamTitle(), detailDTO.getExamDTO().getSubject(), detailDTO.getExamDTO().getDate(), detailDTO.getPresentage()};
                    dtm.addRow(rowData);
                }
            }
    ...
    private void getDetailsForSubject() {
        try {
            ...
            List<ProgressDetailDTO> examList = examController.getAllProgressDetail();
            for (ProgressDetailDTO detailDTO : examList) {
                if (detailDTO.getExamDTO().getSubject().equals(subject)) {
                    Object rowData[] = {detailDTO.getStudentDTO().getName(), detailDTO.getExamDTO().getExamTitle(), detailDTO.getExamDTO().getSubject(), detailDTO.getExamDTO().getDate(), detailDTO.getPresentage()};
                    dtm.addRow(rowData);
                }
            }
